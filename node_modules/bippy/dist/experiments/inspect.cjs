...
var chunk3OWPJH7C_cjs = require('../chunk-3OWPJH7C.cjs');
...
var RawInspector = React14.forwardRef(
  ({ enabled = true, dangerouslyRunInProduction = false }, ref) => {
    ...
    React14.useEffect(() => {
      (async () => {
        if (!element) return;
        const fiber = chunkNGVLXFEV_cjs.getFiberFromHostInstance(element);
        if (!fiber) return;
        const latestFiber = chunkNGVLXFEV_cjs.getLatestFiber(fiber);
        const source = await chunk3OWPJH7C_cjs.getFiberSource(latestFiber);
    ...
    React14.useEffect(() => {
      const handleMouseMove = (event) => {
        const isActive2 = chunkNGVLXFEV_cjs.isInstrumentationActive() || chunkNGVLXFEV_cjs.hasRDTHook();
        if (!isActive2) {
          setIsActive(false);
          return;
        }
        if (!dangerouslyRunInProduction) {
          const rdtHook = chunkNGVLXFEV_cjs.getRDTHook();
          for (const renderer of rdtHook.renderers.values()) {
            const buildType = chunkNGVLXFEV_cjs.detectReactBuildType(renderer);
    ...
    return /* @__PURE__ */ React14__default.default.createElement(React14__default.default.Fragment, null, /* @__PURE__ */ React14__default.default.createElement(
      ...
      /* @__PURE__ */ React14__default.default.createElement(
        ...
        /* @__PURE__ */ React14__default.default.createElement(
          ...
          `<${chunkNGVLXFEV_cjs.getDisplayName(currentFiber.type) || "unknown"}>`
        ),
        /* @__PURE__ */ React14__default.default.createElement(
          "div",
          {
